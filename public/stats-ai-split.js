...
function renderTrackRecord(){
  ...
  var container=document.querySelector('.stats-container')||document.querySelector('#stats-root');
  if(!container && location.hash.includes('predictions')){
    var host=document.querySelector('main .max-w-4xl, main .max-w-6xl, main');
    if(host){
  ...
  box.innerHTML=
    ...
    '<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:20px">'+
      '<div style="background:rgba(34,211,238,.08);border:1px solid rgba(34,211,238,.2);border-radius:12px;padding:18px;text-align:center">'+
        ...
        '<div style="font-size:11px;color:#64748b;margin-top:4px">BTC, ETH, Gold, Oil, TSLA, INTC, AAPL, NVDA, SPX, Silver</div>'+
    ...
    '<div style="background:rgba(255,255,255,.03);border-radius:10px;padding:16px;font-size:13px;color:#94a3b8;line-height:1.7">'+
      ...
      '• <strong style="color:#22d3ee">Guru Bias Signal</strong> fires every few minutes based on market bias scores. Covers 10 assets: BTC, ETH, Gold, Oil, TSLA, INTC, AAPL, NVDA, SPX, Silver.<br>'+
...
if(!location.hash.includes('predictions')) return; setTimeout(renderTrackRecord,600);
})();
